...
async def handle_start(message: Message) -> None:
    await message.answer(
        "👋 Гамарджоба! Я бот-переводчик."
        "Я помогаю быстро переводить грузинский текст, написанный латинскими буквами (грузинский транслит), на чистый русский язык"
        "Как мной пользоваться:"
        "Просто отправь мне любое сообщение или перешли текст из другого чата, а я пришлю тебе готовый перевод."
        "💡 Попробуй прямо сейчас — отправь мне первую фразу!"
    )
